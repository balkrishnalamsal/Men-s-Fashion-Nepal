            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Provider.of<Calculation>(context,listen: false).PageSlidergetImage(section, postid);
                    },
                    child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child:
                                        Text(snapshot.data!.docs.first["name"]),
                                  ),
                                  Row(
                                    mainAxisAlignment:
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text(
                                          snapshot.data!.docs.first["stocks"],
                                          style: TextStyle(
                                            color: Colors.green,
                                            fontSize: 15,
                                          ),
