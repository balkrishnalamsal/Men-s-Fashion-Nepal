              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Padding(
                    ...
                    child: Text("Quantity:",style: TextStyle(color: Colors.deepPurple),),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(top: 10.0,left: 5,right:85),
                    child: Text("Size:$size",style: TextStyle(color: Colors.deepPurple),),
                  ),
                ],
              ),
